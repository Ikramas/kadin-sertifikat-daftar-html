...
import Register from "./pages/Register"; // PERBAIKAN DI SINI: Pastikan mengimpor dari ./pages/Register
        ...
        <BrowserRouter future={{ v7_startTransition: true }}>
          <Routes>
            ...
            <Route path="/" element={<AppLayout />}>
              ...
              <Route path="register" element={<Register />} /> {/* Ini akan merender komponen Register yang benar */}
              ...
              />
              {/* Rute baru untuk detail permohonan menggunakan code_reg */}
              <Route
                path="applications/:code_reg"
                element={<ProtectedRoute requireDocumentVerification={true}><ApplicationDetail /></ProtectedRoute>}
              />
              <Route
                path="certificates"
