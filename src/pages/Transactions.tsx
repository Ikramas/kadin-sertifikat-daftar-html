...
const Transactions: React.FC = () => {
  ...
  useEffect(() => {
    if (isDocumentVerified) {
      ...
      setError("Anda belum dapat melihat transaksi. Silakan lengkapi dokumen registrasi perusahaan terlebih dahulu.");
      setIsLoading(false);
    }
  }, [isDocumentVerified]);
  ...
  const fetchTransactions = async () => {
    ...
    try {
      ...
      setError(err.message || 'Terjadi kesalahan saat memuat daftar transaksi.');
      toast({
        title: 'Gagal Memuat Transaksi',
        description: err.message || 'Terjadi kesalahan saat memuat daftar transaksi.',
        variant: 'destructive',
      });
    } finally {
      setIsLoading(false);
