...
try {
    ...
    $stmt = $db->prepare("
        SELECT 
            c.id, c.certificate_number, c.classification, c.business_field,
            c.qualification, c.issued_date, c.expiry_date, c.status,
            c.issuer_name, c.certificate_file_path, c.created_at,
